    ...
    <section class="section pt-55 mb-50">
        <div class="container-fluid">
            <div class="sign widget">
                ...
                <form class="sign-form widget-form " action='processor.php' 
                method='POST' onsubmit='return validateForm()' >
                    <div class="form-group">
                    
                    <input type="text" class="form-control" placeholder="Name*" name="name" require="required">
                    </div>
                    <div class="form-group">
                    
                    <input type="email" class="form-control" placeholder="Email Address*" name="email" require="required" value="">
                    </div>
                    <div class="form-group">
                    <div class='form-group'>
...
<option  class='form-control ' value='F'>Female</option>
                    ...
                    <input type="password" class="form-control" maxlength='12' minlength='5' require="required" id='password_1' placeholder="Password*" name="password" value="">
                    </div>
                    <div class="form-group">
                    
                    <input type="password" class="form-control" maxlength='12' minlength='5' require="required" id='password_2'
                     placeholder="Re-Enter Password*" name="password" value="">
                    </div>
                    <div class="sign-controls form-group">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="rememberMe">
                        <label class="custom-control-label" for="rememberMe">Agree to our 
                            <a href="#" class="btn-link">terms & conditions</a> </label>
                    </div>
                    </div>
                    <div class="form-group">
                    <button type="submit" name='register' class="btn-custom">Sign Up</button>
                    </div>
